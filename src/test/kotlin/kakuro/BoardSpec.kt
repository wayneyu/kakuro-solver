...
class BoardSpec : Spek({
    ...
    describe("board") {
        ...
        it("should print board") {
            val board = Board(5, 5,
                listOf(
                    NSum(0, 3, 12, 0, 3, arrayOf(2, 3, 7)),
                    NSum(1, 1, 6, 0, 3, arrayOf(1, 2, 3)),
                    NSum(1, 1, 7, 1, 3, arrayOf(1, 2, 4)),
                    NSum(3, 0, 14, 1, 3, arrayOf(2, 5, 7)))
            )
        ...
        it("should create board from layout") {
            ...
            val expected = Board(4, 4,
                    listOf(
                            NSum(0, 3, 12, 0, 3, arrayOf(2, 3, 7)),
                            NSum(1, 1, 6, 0, 3, arrayOf(1, 2, 3)),
                            NSum(1, 1, 7, 1, 3, arrayOf(1, 2, 3)),
                            NSum(3, 0, 14, 1, 3, arrayOf(2, 5, 7)))
            )
